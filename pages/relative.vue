<template>
  ...
  //     }
  // ]
  // const sortRelativeObject = JSON.parse(JSON.stringify(relativeObject))
  // console.log(sortRelativeObject, 'sssssssss')
  //   sortRelativeObject?.data.items = sortRelativeObject?.data.items.filter((item)=> {
  //     console.log(item.category, currentCate.value, 'ooooooooooooo')
  //     return item.category == currentCate.value
  //   })
  
  //   console.log(sortRelativeObject, 'tttttt')
  //   store.setRelative(sortRelativeObject?.data)
  //   console.log(relativeObject, 'eeeeeee')
  })
